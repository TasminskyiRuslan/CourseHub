    ...
    */
    describe('validation', function () {
        it('fails if the course does not exist', function () {
            ...
            deleteJson(route('admin.course.lesson.destroy', ['non-existing-slug', $lesson]))
                ->assertNotFound();
        });
        ...
        it('fails if the lesson does not exist', function () {
            ...
            deleteJson(route('admin.course.lesson.destroy', [$course, 'non-existing-slug']))
                ->assertNotFound();
        });
        ...
        it('fails if the lesson is from another course', function () {
            ...
            deleteJson(route('admin.course.lesson.destroy', [$course, $lesson]))
                ->assertNotFound();
        });
    });
    ...
    */
    describe('caching', function () {
        it('flushes the lesson cache when a lesson is deleted', function () {
            ...
            deleteJson(route('admin.course.lesson.destroy', [
                'course' => $course->slug,
                'lesson' => $lesson->slug
            ]))->assertNoContent();
