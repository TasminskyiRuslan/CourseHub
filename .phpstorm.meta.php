...
'cache.tags.teacher_list','data.date_format','data.date_timezone','data.features.cast_and_transform_iterables','data.features.ignore_exception_when_trying_to_set_computed_property_value',
...
'filesystems.disks.s3.report','filesystems.disks.courses.driver','filesystems.disks.courses.root','filesystems.disks.courses.url','filesystems.disks.courses.visibility',
'filesystems.disks.courses.throw','filesystems.disks.courses.report','filesystems.disks.users.driver','filesystems.disks.users.root','filesystems.disks.users.url',
'filesystems.disks.users.visibility','filesystems.disks.users.throw','filesystems.disks.users.report','filesystems.links./var/www/html/public/storage','l5-swagger.default',
...
'mail.markdown.paths','pagination.courses_per_page','pagination.lessons_per_page','pagination.users_per_page','permission.models.permission',
...
'sanctum.middleware.validate_csrf_token','sanctum.token_ttl.default','sanctum.token_ttl.remember','services.postmark.key','services.resend.key',
...
'session.partitioned','super-admin.name','super-admin.slug','super-admin.email','super-admin.password',
...
'query-builder.convert_field_names_to_snake_case','structure-discoverer.ignored_files','structure-discoverer.structure_scout_directories','structure-discoverer.cache.driver','structure-discoverer.cache.store',
...
'auth.password.forgot','auth.password.reset','auth.verification.verify','auth.verification.send','account.show',
'account.update','account.avatar.update','account.avatar.destroy','course.index','course.show',
...
'SANCTUM_TOKEN_TTL_REMEMBER','UID','GID',);
