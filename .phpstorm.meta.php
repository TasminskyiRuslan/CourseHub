...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'cache.prefix' => 'string',
            'cache.ttl.course' => 'string',
            'cache.ttl.teacher' => 'string',
            'cache.ttl.lesson' => 'string',
            'cache.tags.course_list' => 'string',
            'cache.tags.lesson_list' => 'string',
            'cache.tags.teacher_list' => 'string',
            'cache.tags.course' => 'string',
            ...
            'filesystems.disks.courses.driver' => 'string',
            'filesystems.disks.courses.root' => 'string',
            'filesystems.disks.courses.url' => 'string',
            'filesystems.disks.courses.visibility' => 'string',
            'filesystems.disks.courses.throw' => 'boolean',
            'filesystems.disks.courses.report' => 'boolean',
            'filesystems.disks.users.driver' => 'string',
            'filesystems.disks.users.root' => 'string',
            'filesystems.disks.users.url' => 'string',
            'filesystems.disks.users.visibility' => 'string',
            'filesystems.disks.users.throw' => 'boolean',
            'filesystems.disks.users.report' => 'boolean',
            ...
            'pagination.courses_per_page' => 'string',
            'pagination.lessons_per_page' => 'string',
            'pagination.users_per_page' => 'string',
            ...
            'sanctum.token_ttl.default' => 'integer',
            'sanctum.token_ttl.remember' => 'integer',
...
'cache.prefix','cache.ttl.course','cache.ttl.teacher','cache.ttl.lesson','cache.tags.course_list',
'cache.tags.lesson_list','cache.tags.teacher_list','cache.tags.course','data.date_format','data.date_timezone',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.courses.driver','filesystems.disks.courses.root',
'filesystems.disks.courses.url','filesystems.disks.courses.visibility','filesystems.disks.courses.throw','filesystems.disks.courses.report','filesystems.disks.users.driver',
'filesystems.disks.users.root','filesystems.disks.users.url','filesystems.disks.users.visibility','filesystems.disks.users.throw','filesystems.disks.users.report',
'filesystems.links./var/www/html/public/storage','l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api','l5-swagger.documentations.default.paths.use_absolute_path',
...
'l5-swagger.defaults.ui.authorization.oauth2.use_pkce_with_authorization_code_grant','l5-swagger.defaults.constants.L5_SWAGGER_CONST_HOST','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','pagination.courses_per_page','pagination.lessons_per_page',
'pagination.users_per_page','permission.models.permission','permission.models.role','permission.table_names.roles','permission.table_names.permissions',
...
'sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','sanctum.token_ttl.default','sanctum.token_ttl.remember',
...
'session.http_only','session.same_site','session.partitioned','super-admin.name','super-admin.slug',
'super-admin.email','super-admin.password','boost.enabled','boost.browser_logs_watcher','mcp.redirect_domains',
...
'query-builder.convert_relation_names_to_snake_case_plural','query-builder.convert_relation_table_name_strategy','query-builder.convert_field_names_to_snake_case','structure-discoverer.ignored_files','structure-discoverer.structure_scout_directories',
...
'sanctum.csrf-cookie','auth.register','auth.login','auth.token.destroy','auth.tokens.destroy',
'auth.password.forgot','auth.password.reset','auth.verification.verify','auth.verification.send','auth.show',
'auth.update','auth.avatar.update','auth.avatar.destroy','course.index','course.show',
'teacher.index','teacher.show','teacher.course.index','teacher.course.store','teacher.course.show',
'teacher.course.update','teacher.course.destroy','teacher.course.image.update','teacher.course.image.destroy','teacher.course.publish',
'teacher.course.unpublish','teacher.course.lesson.index','teacher.course.lesson.store','teacher.course.lesson.show','teacher.course.lesson.update',
'teacher.course.lesson.destroy','admin.course.index','admin.course.show','admin.course.destroy','admin.course.ban',
'admin.course.unban','admin.course.lesson.index','admin.course.lesson.show','admin.course.lesson.destroy','admin.user.index',
'admin.user.show','admin.user.destroy','admin.user.role.update','admin.user.ban','admin.user.unban','storage.local',);
        registerArgumentsSet('views', 
'emails.auth.reset','emails.auth.verify','emails.course.ban','emails.course.unban','emails.user.ban',
'emails.user.unban','l5-swagger::index','vendor.l5-swagger.index','welcome','l5-swagger::index',
...
'validation.custom.attribute-name.rule-name','auth.banned','auth.verified','users.protected',);
...
'MYSQL_DATABASE','MYSQL_ROOT_USERNAME','MYSQL_ROOT_PASSWORD','SESSION_DRIVER','SESSION_LIFETIME',
'SESSION_ENCRYPT','SESSION_PATH','SESSION_DOMAIN','BROADCAST_CONNECTION','FILESYSTEM_DISK',
'QUEUE_CONNECTION','CACHE_STORE','CACHE_TTL_COURSE','CACHE_TTL_TEACHER','CACHE_TTL_LESSON',
'CACHE_TAGS_COURSE_LIST','CACHE_TAGS_LESSON_LIST','CACHE_TAGS_USER_LISTEACHER_LIST','CACHE_TAGS_COURSE','MEMCACHED_HOST',
'REDIS_CLIENT','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','REDIS_CACHE_CONNECTION',
'MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD',
'MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY',
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','SUPER_ADMIN_NAME',
'SUPER_ADMIN_SLUG','SUPER_ADMIN_EMAIL','SUPER_ADMIN_PASSWORD','PAGINATION_COURSES_PER_PAGE','PAGINATION_LESSONS_PER_PAGE',
'PAGINATION_USERS_PER_PAGE','AUTH_GUARD','AUTH_VERIFICATION_EXPIRE','L5_SWAGGER_GENERATE_ALWAYS','L5_SWAGGER_CONST_HOST',
'L5_SWAGGER_USE_ABSOLUTE_PATH','SANCTUM_TOKEN_TTL_DEFAULT','SANCTUM_TOKEN_TTL_REMEMBER','UID','GID',);
