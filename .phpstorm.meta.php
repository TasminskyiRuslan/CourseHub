...
'sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','sanctum.token_ttl.default','sanctum.token_ttl.remember','services.postmark.key',
...
'session.same_site','session.partitioned','super-admin.name','super-admin.email','super-admin.password',
...
'auth.tokens.destroy','password.forgot','password.reset','verification.verify','verification.resend',
'courses.index','courses.store','courses.show','courses.update','courses.destroy',
'courses.image.update','courses.image.destroy','courses.publish','courses.unpublish','courses.lessons.index',
'courses.lessons.store','courses.lessons.show','courses.lessons.update','courses.lessons.destroy','storage.local',);
...
'VITE_APP_NAME','SUPER_ADMIN_NAME','SUPER_ADMIN_EMAIL','SUPER_ADMIN_PASSWORD','COURSES_PER_PAGE',
'LESSONS_PER_PAGE','AUTH_GUARD','L5_SWAGGER_GENERATE_ALWAYS','L5_SWAGGER_CONST_HOST','L5_SWAGGER_USE_ABSOLUTE_PATH',
'UID','GID','SANCTUM_TOKEN_TTL_DEFAULT','SANCTUM_TOKEN_TTL_REMEMBER',);
