...
'cache.tags.teacher_list','cashier.key','cashier.secret','cashier.path','cashier.webhook.secret',
'cashier.webhook.tolerance','cashier.webhook.events','cashier.currency','cashier.currency_locale','cashier.payment_notification',
'cashier.invoices.renderer','cashier.invoices.options.paper','cashier.invoices.options.remote_enabled','cashier.logger','data.date_format',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.courses.driver',
'filesystems.disks.courses.root','filesystems.disks.courses.url','filesystems.disks.courses.visibility','filesystems.disks.courses.throw','filesystems.disks.courses.report',
'filesystems.disks.users.driver','filesystems.disks.users.root','filesystems.disks.users.url','filesystems.disks.users.visibility','filesystems.disks.users.throw',
'filesystems.disks.users.report','filesystems.links./var/www/html/public/storage','l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api',
...
'l5-swagger.defaults.ui.authorization.persist_authorization','l5-swagger.defaults.ui.authorization.oauth2.use_pkce_with_authorization_code_grant','l5-swagger.defaults.constants.L5_SWAGGER_CONST_HOST','logging.default','logging.deprecations.channel',
...
'mail.from.address','mail.from.name','mail.markdown.theme','mail.markdown.paths','pagination.courses_per_page',
'pagination.lessons_per_page','pagination.users_per_page','permission.models.permission','permission.models.role','permission.table_names.roles',
...
'sanctum.token_prefix','sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','sanctum.token_ttl.default',
'sanctum.token_ttl.remember','services.postmark.key','services.resend.key','services.ses.key','services.ses.secret',
...
'session.secure','session.http_only','session.same_site','session.partitioned','super-admin.name',
'super-admin.slug','super-admin.email','super-admin.password','boost.enabled','boost.browser_logs_watcher',
...
'cashier.payment','cashier.webhook','sanctum.csrf-cookie','auth.register','auth.login',
'auth.token.destroy','auth.tokens.destroy','auth.password.forgot','auth.password.reset','auth.verification.verify',
'auth.verification.send','account.show','account.update','account.avatar.update','account.avatar.destroy',
'courses.index','courses.show','teachers.index','teachers.show','student.courses.checkout',
'student.courses.index','student.courses.show','student.courses.lessons.index','student.courses.lessons.show','teacher.courses.index',
'teacher.courses.store','teacher.courses.show','teacher.courses.update','teacher.courses.destroy','teacher.courses.image.update',
'teacher.courses.image.destroy','teacher.courses.publish','teacher.courses.unpublish','teacher.courses.lessons.index','teacher.courses.lessons.store',
'teacher.courses.lessons.show','teacher.courses.lessons.update','teacher.courses.lessons.destroy','admin.courses.index','admin.courses.show',
'admin.courses.destroy','admin.courses.ban','admin.courses.unban','admin.courses.lessons.index','admin.courses.lessons.show',
'admin.courses.lessons.destroy','admin.users.index','admin.users.show','admin.users.destroy','admin.users.role.update',
'admin.users.ban','admin.users.unban','storage.local',);
        registerArgumentsSet('views', 
'emails.auth.reset','emails.auth.verify','emails.course.ban','emails.course.unban','emails.user.ban',
'emails.user.unban','l5-swagger::index','vendor.l5-swagger.index','welcome','cashier::invoice',
'cashier::payment','l5-swagger::index','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'CACHE_TAGS_COURSE_LIST','CACHE_TAGS_TEACHER_LIST','MEMCACHED_HOST','REDIS_CLIENT','REDIS_HOST',
...
'AUTH_VERIFICATION_EXPIRE','L5_SWAGGER_GENERATE_ALWAYS','L5_SWAGGER_CONST_HOST','L5_SWAGGER_USE_ABSOLUTE_PATH','SANCTUM_TOKEN_TTL_DEFAULT',
'SANCTUM_TOKEN_TTL_REMEMBER','UID','GID','STRIPE_KEY','STRIPE_SECRET',
'STRIPE_WEBHOOK_SECRET','CASHIER_CURRENCY','CASHIER_CURRENCY_LOCALE',);
