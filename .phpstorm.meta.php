...
'cache.ttl.course','cache.ttl.lesson','cache.tags.course_list','cache.tags.lesson_list','cache.tags.course',
...
'filesystems.disks.courses.driver','filesystems.disks.courses.root','filesystems.disks.courses.url','filesystems.disks.courses.visibility','filesystems.disks.courses.throw',
'filesystems.disks.courses.report','filesystems.links./var/www/html/public/storage','l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api',
...
'pagination.lessons_per_page','permission.models.permission','permission.models.role','permission.table_names.roles','permission.table_names.permissions',
...
'session.http_only','session.same_site','session.partitioned','super-admin.name','super-admin.email',
'super-admin.password','boost.enabled','boost.browser_logs_watcher','mcp.redirect_domains','query-builder.parameters.include',
...
'query-builder.convert_relation_table_name_strategy','query-builder.convert_field_names_to_snake_case','structure-discoverer.ignored_files','structure-discoverer.structure_scout_directories','structure-discoverer.cache.driver',
...
'sanctum.csrf-cookie','auth.register','auth.login','auth.me','auth.logout',
'auth.logout.all','auth.password.forgot','auth.password.reset','auth.verification.verify','auth.verification.resend',
'course.index','course.store','course.show','course.update','course.destroy',
'course.image.update','course.image.destroy','course.publish','course.unpublish','course.lesson.index',
'course.lesson.store','course.lesson.show','course.lesson.update','course.lesson.destroy','storage.local',);
...
'QUEUE_CONNECTION','CACHE_STORE','CACHE_TTL_COURSE','CACHE_TTL_LESSON','CACHE_TAGS_COURSE_LIST',
'CACHE_TAGS_LESSON_LIST','CACHE_TAGS_COURSE','MEMCACHED_HOST','REDIS_CLIENT','REDIS_HOST',
...
'COURSES_PER_PAGE','LESSONS_PER_PAGE','AUTH_GUARD','L5_SWAGGER_GENERATE_ALWAYS','L5_SWAGGER_CONST_HOST',
